...
import { Calendar, Clock, MapPin, Tag, Bookmark, Users, QrCode, Wallet, ImagePlus, Image as ImageIcon } from "lucide-react";
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
      ...
      const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        if (e.target.files?.[0]) {
          ...
          reader.onloadend = () => {
            setEventData((prev) => ({ ...prev, poster: reader.result as string }));
          };
                      ...
                      <CardContent className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {[
                            ...
                            { icon: Wallet, label: "Budget (Optional)", name: "budget", type: "number" },
                          ].map((field, index) => (
                    ...
                    <Card className="mt-6 shadow-sm">
                      ...
                      <CardContent>
                        <div className="border-2 border-dashed rounded-lg overflow-hidden">
                          {eventData.poster ? (
                            <img src={eventData.poster} alt="Event poster" className="w-full h-full object-cover" />
                          ) : (
